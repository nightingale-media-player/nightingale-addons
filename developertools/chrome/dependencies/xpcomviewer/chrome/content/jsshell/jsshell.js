...
// SONGBIRD HACK - hook up the remote API
var Cc = Components.classes;
var Ci = Components.interfaces;
var songbird = Cc["@songbirdnest.com/remoteapi/remoteplayer-factory;1"]
                .getService(Ci.sbIRemotePlayerFactory)
                .createPrivileged(window.QueryInterface(Ci.nsIInterfaceRequestor)
                .getInterface(Ci.nsIWebNavigation).currentURI, window);
